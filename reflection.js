// DOM Elements
const form = document.getElementById("reflections");
const savedReflections = document.getElementById("savedReflections");

// Load saved entries from localStorage
function loadEntries() {
    const entries = JSON.parse(localStorage.getItem("reflections")) || [];
    savedReflections.innerHTML = ""; // To clear existing entries
    entries.forEach((entry, index) => {
        ...
        `;
        savedReflections.appendChild(entryDiv);
    });
}
